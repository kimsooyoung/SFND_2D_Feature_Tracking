...
Imagine such case, There's few similar patterns in image, Distacne Ratio extract the distace between best 2 features in consecutive image, and we can catch mismatches by implementing (descriptor + distance ratio) combined descriptor.
