...
Here's the implementation. Those are written in `matching2D_Student.cpp`
...
### 5. Implement matching algorithms, Brute Force matching combined with Nearest-Neighbor selection, FLANN as an alternative to brute-force as well as the K-Nearest-Neighbor approach.
...
Q: What is Distance Ratio and Why should it be used?

A: Imagine such case, There's few similar patterns in image, Distacne Ratio extract the distace between best 2 features in consecutive image, and we can catch mismatches by implementing (descriptor + distance ratio) combined descriptor.

![Screenshot from 2020-02-24 15-54-11](https://user-images.githubusercontent.com/12381733/75133391-eec86500-571d-11ea-950f-016a28be57a5.png)
...
> Here's [Google Spread Sheet link](https://docs.google.com/spreadsheets/d/1H2qoxqAklakkGRWDTFXGNOmsREILkXQJLmi7ttRISDM/edit?usp=sharing) for my Tasks
